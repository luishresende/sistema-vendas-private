...
@NamedQueries({
    ...
    @NamedQuery(name = "TbCidEst.findByCeCidId", query = "SELECT t FROM TbCidEst t WHERE t.tbCidEstPK.ceCidId = :ceCidId"),
    @NamedQuery(name = "TbCidEst.findByCeEstSigla", query = "SELECT t FROM TbCidEst t WHERE t.tbCidEstPK.ceEstSigla = :ceEstSigla")})
